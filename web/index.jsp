    ...
    <body>
            ...
            <header>
                ...
                <div class="form-group">
                    <h2 style="text-align: center ;color:#fff;">Loguin Paciente</h2>
                    <form name="form1" method="post" action="ServletLogueo" onsubmit="return validar()">
                       ...
                       %>
                        ...
                        <div class="texto"><a href="index_1.jsp" class="enlaceRojo">Iniciar Sesion como Medico</a></div>
